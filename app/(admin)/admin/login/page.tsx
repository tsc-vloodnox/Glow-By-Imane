  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[var(--color-sand)] px-4">
      <Suspense
        fallback={
          <div className="w-full max-w-md rounded-2xl border border-[var(--color-border)] bg-white p-6 shadow-sm">
            <div className="h-7 w-40 animate-pulse rounded-lg bg-[var(--color-sand)]" />
            <div className="mt-6 space-y-4">
              <div className="h-12 animate-pulse rounded-xl bg-[var(--color-sand)]" />
              <div className="h-12 animate-pulse rounded-xl bg-[var(--color-sand)]" />
              <div className="h-12 animate-pulse rounded-full bg-[var(--color-sand)]" />
            </div>
          </div>
        }
      >
